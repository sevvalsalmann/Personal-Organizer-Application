...
namespace WindowsFormsApp2
{
    public partial class FormUserManegement : Form, IReminderObserver
    {
        ...
        // Constructor - form başlatılırken çağrılır
        public FormUserManegement(UserManager userManager)
        {
            ...
            // Admin kullanıcıları için hatırlatıcı gözlemci kaydı yapılıyor
        ...
        // Başlık güncelleme - IReminderObserver arayüzü uygulaması
        public void RefreshHeader(string summary)
        {
            GlobalSettings.UpdateHeader(this, summary);
        }

        // Pencere titreşimi - IReminderObserver arayüzü uygulaması
        ...
        {
            // Excel dosyasındaki kullanıcıları DataGridView'da görüntüleme
        ...
        private void btn_sil_Click(object sender, EventArgs e)
        {
            ...
            // Admin üzerinde işlem yapılamaz kontrolü
            ...
            users.RemoveAll(u => u.Username == usernameToDelete); // Yerel listeden kullanıcıyı kaldır

            // DataGridView güncellemesi
            usersDataGridView.DataSource = null; // DataSource'u temizle
            usersDataGridView.DataSource = users; // DataGridView'ı yeniden bağla
            usersDataGridView.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
            usersDataGridView.Columns["NotesManager"].Visible = false;
            usersDataGridView.Columns["PhoneBook"].Visible = false;

            // Kullanıcı değişikliklerini Excel'e kaydet
            ...
            // Kullanıcıya ait tüm ilişkili dosyaları sil
        ...
        private void btn_güncelle_Click(object sender, EventArgs e)
        {
            ...
            // Kullanıcı tipini radio butonlardan al
            ...
            {
                // Seçili satırın hücrelerini metin kutularından gelen değerlerle güncelle
                ...
                // E-posta ve telefon numarası doğrulama kontrolleri
                ...
                // Seçili kullanıcının bilgilerini güncelle
                ...
                // Seçili satır indeksini sıfırla
                selectedRowIndex = -1;
