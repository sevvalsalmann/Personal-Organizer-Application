namespace WindowsFormsApp2
{
    partial class FormUserManegement
    {
        ...
        private System.Windows.Forms.TabPage tabPage2; // Second tab page in the tab control
        private System.Windows.Forms.TabPage tabPage1; // First tab page in the tab control
        ...
        private System.Windows.Forms.Button updateButton; // Button to update data
        private System.Windows.Forms.Button deleteButton; // Button to delete data
        private System.Windows.Forms.TextBox userNameTextBox; // TextBox for username input
        private System.Windows.Forms.TabControl mainTabControl; // Main tab control for organizing sections
        ...
        private System.Windows.Forms.GroupBox userTypeGroupBox; // GroupBox for user type selection
        private System.Windows.Forms.RadioButton userRadioButton; // Radio button for standard user type
        private System.Windows.Forms.RadioButton partTimeUserRadioButton; // Radio button for part-time user type
        private System.Windows.Forms.DataGridView usersDataGridView; // DataGridView to display user information
        private System.Windows.Forms.Panel headerPanel; // Panel for the form's header bar
        private System.Windows.Forms.Label appNamelLabel; // Label for the application name in the header
        ...
        private System.Windows.Forms.ProgressBar mailProgressBar; // ProgressBar for mail sending operation
        private System.Windows.Forms.Button sendMailButton; // Button to send mail
        private System.Windows.Forms.Button addButton; // Button to add new data
    }
}